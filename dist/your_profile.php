...
<div  class="whole-div flex flex-row">
        ...
        <div class=" flex justify-center items-center w-screen h-screen">
            <div class="flex flex-col border-2 rounded-md bg-white">
                <div class="border-2">
                ...
                <div class="m-5">
                    <table class="border-2">
                        <tr class="border-b-2">
                            <th class="flex justify-start w-48 font-normal pl-3 pb-3">
                                <h1 class="text-xl">Name</h1>
                            </th>
                            <td class="border-l-2 text-xl pb-3 pl-5 pr-5">
                                <?php echo $row['user_name'] ?>
                            </td>
                        </tr>
                        <tr class="border-b-2">
                            <th class="flex justify-start w-48 pb-3 pl-3 font-normal">
